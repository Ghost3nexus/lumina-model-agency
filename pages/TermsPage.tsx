    ...
    <div className="min-h-screen bg-[#050508] text-gray-100">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-gray-300 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-gray-100 mt-8">第4条（料金・支払い）</h2>
          <p>1. 本サービスの料金は、Studio利用料及びモデル使用ライセンス料から構成されます。</p>
          <p>2. Studio利用料は月額サブスクリプション方式とし、所定のクレジット数が付与されます。</p>
          <p>3. モデル使用ライセンス料は、指名するモデル及びライセンス種別に応じて別途発生します。</p>
          <p>4. 支払いはStripeを通じたクレジットカード決済により行われます。</p>
          <p>5. 月途中での解約による日割り返金は行いません。</p>
          ...
          <p>1. 本サービスはAI技術を使用しており、生成結果の品質を完全に保証するものではありません。</p>
          <p>2. 生成画像が第三者の権利を侵害しないことを保証するものではありません。</p>
          <p>3. サービスの中断・停止に伴う損害について、当社は責任を負いません。</p>
