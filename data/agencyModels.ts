...
export const AGENCY_MODELS: AgencyModel[] = [
  ...
  { id: 'men-asia-02', name: 'JIHO', category: 'men_asia', height: 182, measurements: { bust: 87, waist: 69, hips: 87 }, hair: 'Black, medium-long, soft', eyes: 'Dark brown, double lid', vibe: 'Androgynous editorial, Raf Simons / Loewe', ...m('men-asia-02', { main: '/agency-models/men-asia-02/campaign.png', beauty: '/agency-models/men-asia-02/muse-portrait.png', editorial: '/agency-models/men-asia-02/v3-campaign.png' }) },
  ...
  { id: 'influencer-girl-01', name: 'RINKA', category: 'influencer', height: 165, measurements: { bust: 78, waist: 58, hips: 84 }, hair: 'Pink-ash, shoulder length', eyes: 'Dark brown', vibe: 'Tokyo street style, Harajuku creative', ...m('influencer-girl-01', { main: '/agency-models/influencer-girl-01/v3-campaign.png', polaroid: '/agency-models/influencer-girl-01/campaign.png', beauty: '/agency-models/influencer-girl-01/v3-muse-portrait.png', editorial: '/agency-models/influencer-girl-01/v3-verve-cover.png' }) },
  { id: 'influencer-boy-01', name: 'KAI', category: 'influencer', height: 178, measurements: { bust: 88, waist: 72, hips: 88 }, hair: 'Dark brown, curly-wavy', eyes: 'Light brown', vibe: 'Tokyo × Byron Bay, lifestyle creative', ...m('influencer-boy-01', { main: '/agency-models/influencer-boy-01/v3-campaign.png', polaroid: '/agency-models/influencer-boy-01/campaign.png', beauty: '/agency-models/influencer-boy-01/v3-muse-portrait.png', editorial: '/agency-models/influencer-boy-01/verve-cover.png' }) },
