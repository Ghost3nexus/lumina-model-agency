...
function m(id: string) {
  ...
  return {
    images: { main: `${b}/beauty.png`, polaroid: `${b}/polaroid-front.png`, beauty: `${b}/beauty.png`, editorial: `${b}/editorial.png` },
...
export const AGENCY_MODELS: AgencyModel[] = [
  ...
  { id: 'ladies-asia-02', name: 'HARIN', category: 'ladies_asia', height: 174, measurements: { bust: 79, waist: 58, hips: 87 }, hair: 'Black, long, straight', eyes: 'Dark brown, double lid', vibe: 'K-beauty editorial, Celine / quiet luxury', ...m('ladies-asia-02') },
  { id: 'ladies-asia-03', name: 'LIEN', category: 'ladies_asia', height: 176, measurements: { bust: 79, waist: 58, hips: 86 }, hair: 'Dark brown, modern shag', eyes: 'Dark brown, almond', vibe: 'Franco-Asian editorial, Dior / Loewe', ...m('ladies-asia-03') },
  { id: 'men-intl-01', name: 'IDRIS', category: 'men_international', height: 189, measurements: { bust: 92, waist: 74, hips: 90 }, hair: 'Black, short fade', eyes: 'Dark brown', vibe: 'Luxury menswear, Prada / Dior Homme', ...m('men-intl-01') },
  ...
  { id: 'men-asia-03', name: 'TAKU', category: 'men_asia', height: 180, measurements: { bust: 90, waist: 72, hips: 89 }, hair: 'Black with grey temples, short', eyes: 'Dark brown', vibe: 'Mature menswear, Auralee / COMOLI', ...m('men-asia-03') },
  { id: 'influencer-girl-01', name: 'RINKA', category: 'influencer', height: 165, measurements: { bust: 78, waist: 58, hips: 84 }, hair: 'Pink-ash, shoulder length', eyes: 'Dark brown', vibe: 'Tokyo street style, Harajuku creative', ...m('influencer-girl-01') },
