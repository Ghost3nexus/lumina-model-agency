...
export interface AgencyModel {
  ...
  studioRefs?: string[];
  /** Optional full-body proportion reference — a canonical runway-balance shot
   *  the generator should match for 8+head silhouette, leg length, and framing.
   *  Injected into every Studio generation as an explicit proportion target. */
  proportionRef?: string;
